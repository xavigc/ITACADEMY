...
-- Hacemos lo mismo con la credit_card que tampoco existe
 INSERT INTO credit_card (	id ,company_id, transaction_id, iban,pan,pin,cvv,expiring_date)
 VALUES ('CcU-9999', 'b-9999', NULL, NULL,NULL,NULL,NULL,NULL);
...
CREATE OR REPLACE VIEW InformeTecnico AS(
										SELECT t.id as tx_id, name, surname, iban, company_name,amount, lat, longitude
                                        FROM transaction t
